...
check whether some participants appear in only the baseline or amyloid dataset (study id)

```{r}
same_id_baseline = sum(baseline_df$id %in% amyloid_df$id) # check # of id in baseline apper in amyloid
```
