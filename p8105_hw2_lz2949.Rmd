...
MtrashW_df = 
  read_excel("./data/202309 Trash Wheel Collection Data.xlsx", sheet = "Mr. Trash Wheel", range = "A2:N547") |>
  janitor::clean_names() |>
  mutate(
    homes_powered = (
      weight_tons*500/30
...
```{r}
PtrashW_df = 
  read_excel("./data/202309 Trash Wheel Collection Data.xlsx", sheet = "Professor Trash Wheel", range = "A2:M96") |>
  janitor::clean_names() |>
    mutate(
    year = as.character(year),
    homes_powered = (
...
Gwynnda_df = 
  read_excel("./data/202309 Trash Wheel Collection Data.xlsx", sheet = "Gwynnda Trash Wheel", range = "A2:K108") |>
  janitor::clean_names() |>
    mutate(
    year = as.character(year),
    homes_powered = (
