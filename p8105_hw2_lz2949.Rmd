...
The total number of participants is `r nrow(baseline_df)`. Among those, `r nrow(c_baseline_df)` developed MCI. The average baseline age of those `r nrow(c_baseline_df)` patients is `r round(mean(as.numeric(c_baseline_df$age_at_onset)), digits=2)`. In this study, `r nrow(subset(c_baseline_df, sex == "female" & apoe4 == "APOE4 carrier"))` female patients are apoe4 carrier, which counts for `r round(nrow(subset(c_baseline_df, sex == "female" & apoe4 == "APOE4 carrier"))/nrow(c_baseline_df)*100, digits = 2)`% proportion of total patients. 
