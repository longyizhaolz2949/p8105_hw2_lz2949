...
MtrashW_df = 
  ...
  janitor::clean_names() |>
  subset(select = -c(date, x15, x16, dumpster)) |> # update homes_powerd
  mutate(
    homes_powered = (
      weight_tons*500/30
    )
...
use similar process to import, clean, and organize data for Professor Trash Wheel and Gwynnda. combine these with Mr. Trash Wheel. 
